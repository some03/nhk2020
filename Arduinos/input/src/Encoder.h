...
class Encoder{
	...
	int Encoder::b[4]={23,22,21,20};
    int Encoder::a[4]={2,3,4,5};
...
Encoder::Encoder(){
    ...
    attachInterrupt(2,Encm0,RISING);
    attachInterrupt(3,Encm1,RISING);
    attachInterrupt(4,Encm2,RISING);
    attachInterrupt(5,Encm3,RISING);
}
